...
if (isset($_GET['userid'])) {
    ...
    global $conn;
    $query = "select * from students order by datetime desc";
...
<body style="background-color: rgb(201, 176, 202);">
    <div class="container-fluid">
        ...
        <div class="navigation bg-white navbar navbar-expand-sm position-fixed" style="width: 100%;z-index:999;">
                <ul class="nav ">
                    ...
                    <div class="collapse navbar-collapse" id="top-nav">
                        <li class="nav-link"><a href="./admin.php"><i class="fa fa-home" aria-hidden="true"></i>home</a></li>
                        <li class="nav-link"><a href="#studentsdata">sudents data</a></li>
                        <li class="nav-link"><a href="#grades">grades</a></li>
                        <li class="nav-link"><a href="#addtocourse">add data to course</a> </li>
                        <li class="nav-link"><a href="#editdata">edit data</a></li>
                        <li class="nav-link"><a href="#adminlist">admin list</a></li>
        ...
        <div class="row" style="margin-top:90px;">
            <div class="main">
                ...
                <h2 class="center"id="studentsdata" ><u> Students Data</u></h2>
                <table class="table table-responsive table-dark table-bordered table-hover" border="1">
                    <tr>
                    <th>s/no</th>
                    <th>First Name</th>
                    <th>Last Name</th>
                ...
                <h2 class="center" id="grades"><u>Grades</u></h2>
            ...
            <!--edit data-->
            <h2 class="center" id="editdata"><u> Edit Data</u></h2>
            ...
            <div class="loader">
                <form action="#" method="post">
                    ...
                    <input type="submit" value="load data(Refresh site)" name="loader" class="btn btn-primary btn-block">
                </form>
            </div>
            <div class="form1">
            ...
            <div>
                <h2 id="adminlist" class="center"><u>administration list</u> </h2>
                <table class="table table-responsive table-dark table-bordered table-hover" border="1">
                    <tr>
                    <th>s/no</th>
                    <th>First Name</th>
